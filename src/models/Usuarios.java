...
/**
 * Classe modelo que representa a tabela de usuários no DB a classe é estilo
 * POJO (Plain Old Java Object), por isso tem construtores vazios, aparentemente
 * é pela ausencia de frameworks. Modelos recentes parecem usar um processo de
 * JPA (Java Persistence API), e pelo que vi, a escrita desse estilo JPA é bem
 * similar a escrita do script do DB
 *
 * @author Alex
 */
...
public class Usuarios {
    ...
    private boolean senha_padrao = true;    // Se está usando a senha padrão, para forçar uma troca no primeiro login
    private String cargo;
    private boolean ativo = true; // Se a conta é ativa ou não. No DB é a "condicao"
    private String perfil; // Nível de acesso às informações do sistema

    // Campos do soldador, para outros cargos eles ficam nulos
    private Usuarios supervisor; // Auto referência da classe para ser usada no DAO
    private String sinete;
    private LocalDate validade_certificado;
    private LocalDate ultima_solda;

    // Construtor vazio para o DAO conseguir se comunicar com o DB e puxar as informações
    public Usuarios() {
    }
    ...
    public LocalDate getValidade() { return validade_certificado; }
    public LocalDate getSolda() { return ultima_solda; }

    // ! =============== MÉTODOS IS ===============
    public boolean isSenhaPadrao() { return senha_padrao; }
    ...
    public void setSenhaPadrao(boolean senha_padrao) { this.senha_padrao = senha_padrao; }
    ...
    public String toString() {
        // Para especificar o funcionário e o cargo que executou uma ação, tipo gerar um relatório
