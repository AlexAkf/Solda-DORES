 ...
 * @author hugos
 */
public class CadastroJuntas extends javax.swing.JFrame {

    private final TelaJuntas telaJuntas;

    public CadastroJuntas(TelaJuntas telaJuntas) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CADASTRAR JUNTA");
        jPanel1.add(jLabel1);
        ...
        jPanel1.add(jLabel5);
        jLabel5.setBounds(20, 200, 210, 30);
    ...
    private void botaoCadastrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botaoCadastrarMouseClicked
        ...
        status = switch (selecionado) {
            case "Não realizado" -> "nao_realizado";
            case "Em andamento" -> "em_andamento";
            case "Concluído" -> "concluido";
            case "A refazer" -> "refazer";
            default -> "nao_realizado";
        };
        ...
        boolean sucesso = dao.inserirJunta(j);
